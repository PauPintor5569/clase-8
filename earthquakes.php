...
<div class="col-sm-12 col-lg-10 col-lg-offset-1">
  <section>
    ...
    <?php $cl++ ;?>
    <li <?php if ($json_data['features'][$n]['properties']['mag'] >= 6){?> style="color:RGB(254, 21, 36);" <?php }
     if ($json_data['features'][$n]['properties']['mag'] <= 4){ ?> style="color:RGBA(149, 183, 184, 0);" <?php }
     elseif ($json_data['features'][$n]['properties']['mag'] >= 5.5) {?> style="color:RGB(224, 121, 136);" <?php }
     elseif ($json_data['features'][$n]['properties']['mag'] >= 5) {?> style="color:RGB(154, 21, 36);" <?php }
     elseif ($json_data['features'][$n]['properties']['mag'] >= 4.5) {?> style="color:RGB(20, 221, 136);" <?php }
     else{ ?> style="color:RGB(100, 100, 100);" <?php };?>>
